...
SRCS=Camera.cpp GLSLShader.cpp ShaderSystem.cpp SkyboxRenderer.cpp Skybox.cpp MainGame.cpp Errors.cpp InputManager.cpp Texture.cpp FPSLimiter.cpp main.cpp VertexBuffers.cpp AssimpModel.cpp AssimpMesh.cpp Lighting.cpp
